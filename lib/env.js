...
export function readEnv(source = process.env) {
  const parsed = envSchema.safeParse({
    ...
    SUPABASE_ANON_KEY: source.SUPABASE_ANON_KEY || source.EXPO_PUBLIC_SUPABASE_ANON_KEY || source.NEXT_PUBLIC_SUPABASE_ANON_KEY || source.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY || '',
