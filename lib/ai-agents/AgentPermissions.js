import { AgentPermissionLevel, isLevel4Permission, permissionAllows } from './contracts.js';
...
export class AgentPermissions {
  ...
  canRun(agent) {
    if ((isLevel4Permission(this.autonomyLevel) || isLevel4Permission(agent.permissionLevel)) && !this.allowLevel4) {
